/**
 * LLM prompt templates and response types.
 * Port of goldencheck/llm/prompts.py.
 * Edge-safe: no Node.js dependencies.
 */

export const SYSTEM_PROMPT = `You are a data quality analyst. You are given a dataset summary with representative samples for each column, along with findings from automated profilers.
...
export interface LLMColumnAssessment {
